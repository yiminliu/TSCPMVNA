...
public class BillService {
	...
	public void addComponent(
			...
			Package iPackage,
			Component componentid) throws BillingException {
	...
	public void addPackage(
			Account account,
			ServiceInstance serviceinstance,
			Package iPackage) throws BillingException {
		if (account == null || account.getAccountNo() <= 0) {
	...
	public void addPayment(
			Account account,
			String paymentAmount) throws BillingException {
	...
	public void addServiceInstance(
			Account account,
			ServiceInstance serviceinstance) throws BillingException {
		if (account == null || account.getAccountNo() <= 0) {
			throw new BillingException("addServiceInstance", "Error adding service to unknown Account");
		}
		if (serviceinstance == null || serviceinstance.getExternalId() == null || serviceinstance.getExternalId().trim().length() <= 0) {
	...
	public void deleteServiceInstance(
		...
		MessageHolder message = port.disconnectServicePackages(USERNAME, Integer.toString(account.getAccountNo()), serviceinstance.getExternalId(),
				serviceinstance.getExternalIdType(), DateUtils.getXMLCalendarNextDay(), DISC_REASON);
	...
	public List<Component> getComponentList(
			Account account,
			ServiceInstance serviceinstance,
			Package packageinstance) throws BillingException {
		if (account == null || account.getAccountNo() <= 0) {
	...
	public void updateServiceInstanceStatus(
			ServiceInstance serviceInstance,
			int newThreshold) throws BillingException {
		...
		MessageHolder messageHolder = port.updateThreshold(USERNAME, serviceInstance.getExternalId(), serviceInstance.getExternalIdType(),
				Integer.toString(newThreshold));
